...
<x-layout title="Homepage">
    ...
    <div class="bg-moss-light">
        ...
        <div class="flex justify-between items-center p-[5%]">
            ...
            <img src="{{ asset('images/homepage-image-1.jpg') }}" alt="homepage afbeelding"
                class="w-[30vw] h-auto rounded-[4vw]">
    ...
    <div class="flex flex-col justify-center items-center">
        ...
        <img src="{{ asset('images/homepage-image-2.jpg') }}" alt="zo werkt het afbeelding"
            class="w-[45vw] h-auto mb-[2vw] rounded-[4vw]">
    ...
    <div class="flex flex-col justify-center items-center gap-[2vw] w-[45vw] ml-[27.5vw]">
        ...
        <p>Iedereen een eerlijke kans op een baan. Daar draait het om bij Open Hiring. Het gaat er niet om of iemand een
            diploma, vlotte babbel of bakken ervaring heeft, maar of iemand wíl en kan werken. Bedrijven die mensen
            ...
            krijgen we mensen snel (weer) aan het werk.</p>
        <img src="{{ asset('images/homepage-image-3.jpg') }}" alt="zo werkt het afbeelding"
            class="w-[30vw] h-auto mb-[2vw] rounded-[4vw]">
    </div>
</x-layout>
