...
<x-layout>
    <div class="bg-cream min-h-screen flex items-center justify-center">
        <form action="{{ route('ratings.store', ['vacature' => $vacature->id]) }}" method="POST" class="bg-cream p-8-plus rounded-lg shadow-custom-light mx-auto max-w-3xl">
            @csrf

            <h1 class="text-2.5xl font-bold text-moss-dark mb-6">Nieuwe Beoordeling</h1>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="review" id="review" rows="4"
                              class="w-full p-4 bg-moss-light rounded-lg focus:ring-2 focus:ring-moss-medium focus:outline-none placeholder-black"></textarea>
                </div>
            </div>
